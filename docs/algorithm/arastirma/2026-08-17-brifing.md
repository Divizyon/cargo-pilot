...
**İlgili dosyalar:** `docs/algorithm/01-kurallar.md` (bağlayıcı kurallar) · `docs/algorithm/03-yol-haritasi.md`
(faz planı) · `docs/algorithm/04-olcum-gunlugu.md` (ham ölçüm tablosu)
