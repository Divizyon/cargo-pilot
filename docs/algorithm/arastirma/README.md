...
| [2026-08-19-notlar-gorsel-test-revize.md](2026-08-19-notlar-gorsel-test-revize.md) | 19 Ağu 2026 | *Kısmi yük rejimi.* Görsel testte çıkan `G-1`…`G-4` kusurlarının literatür teşhisi: dördünün ortak kökü **problem sınıfı uyumsuzluğu** — sığan yük SKP değil **açık boyut** problemidir. Dört öncelik: leksikografik amaç, referans uzunluk + bisection, `L(b)` kesit kombinasyonu, artımlı motor çağrısı |
| [2026-08-20-yanit-lifo-multidrop.md](2026-08-20-yanit-lifo-multidrop.md) | 20 Ağu 2026 | *LIFO/multi-drop doluluk kaybı.* Kuralımızın literatürden **daha sert** olduğunu (visibility + reachability katı birleşimi) ve kaybın literatür bandının üst ucunda olduğunu gösterdi. Beş öneri: erişilebilirlik cezası, stack-first, onarım geçişi, reachability gevşetmesi, tek yönlü kural. **Tetiklediği kararlar:** `DR-69` (Ö1 uygulandı → ölçülüp geri alındı), `L-8` (Ö4 ölçüldü, karar iş biriminde); Ö2 ve Ö5 kapandı |
| [2026-08-20-yanit-kirilganlik-istif-agirlik.md](2026-08-20-yanit-kirilganlik-istif-agirlik.md) | 20 Ağu 2026 | *Kırılganlık, istif sınırı, ağırlık.* Kırılganlık kuralımızın Gendreau C7a doğrudan-temas tanımından üç eksende katı olduğunu, kırılgan payımızın (%33) literatür normunda olduğunu (Krebs-Ehmke ~%30) ve CoG'un doluluğu bozmadan uygulanabildiğini (Ramos vd. 2018) söylüyor. **Uyarı:** merkezî iddiası (*"doğrudan-temasa geçiş kaybın çoğunu geri kazandırır"*) `K-1` ölçümüyle çelişiyor — ölçülen kazanç +0,39 puan |
| [2026-08-19-gercek-yukleme-verisi-kaynaklari.md](2026-08-19-gercek-yukleme-verisi-kaynaklari.md) | 19 Ağu 2026 | *Gerçek yükleme verisi nerede.* ROADEF/EURO 2022 Renault verisi birincil öneri (indirildi, doğrulandı); NMFTA, Ceschia-Schaerf, LRTOD ikincil. Çıkarılmış dağılım tabloları [2026-08-19-roadef2022-ozet/](2026-08-19-roadef2022-ozet/) |
