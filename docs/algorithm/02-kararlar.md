...
| **DR-45 ⚠** | **GRASP kutuların %45'ini hiçbir duvara koymuyor — açık ürün kararı** | `ScanPockets` kutuyu duvar bandı olmadan yerleştirir ve duvar kaydetmez; `PocketBeforeNewWall` geni açıkken bu yol duvar açmadan **önce** denenir ve boş konteynerde her zaman başarılı olur. Ölçüldü: static %0,0 duvar dışı, **GRASP %45,0**. Yani arama, doluluğun 5 puanını duvar disiplininden vazgeçerek kazanıyor. Kod bu ödünleşimi bilinçli olarak açıklıyor (*"duvar disiplini bir çıktı biçimidir, fiziksel kural değil"*) ama **oranı kimse ölçmemişti**. Katman inşası sahada yüklenemediği için reddedilmişti (`DR-12`); bu, aynı sorunun daha yumuşak hâli olabilir. **Karar kullanıcıya ait**, üç seçenek ölçüm günlüğünde |
