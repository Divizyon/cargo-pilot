...
| **DR-44** | **Duvar yüzü tam kaplanmıyor — Öneri 3 ölçümle doğrulandı** | `WallDiagnostics` yazıldı (`R-C14`'ün hiç üretilmeyen `WallCount`/`AvgWallFlushness` metrikleri, `DR-38`'in bir parçası). BR1/GRASP: yüz kaplama ortalama **%90,9**, en düşük %85,5, duvarların **%77'si %95 eşiğinin altında**. Ölü hava neredeyse eşit bölünüyor: kenar şeridi %5,8 · tavan artığı %6,2 — yani hem kesit hem yükseklik sorunu var, ikisi ayrı müdahale ister |
