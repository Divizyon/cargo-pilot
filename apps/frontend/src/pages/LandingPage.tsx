...
function Features() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-72 h-[480px] hidden lg:block pointer-events-none select-none z-10" aria-hidden>
        <CraneAnimation mirror={false} />
      </div>
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-72 h-[480px] hidden lg:block pointer-events-none select-none z-10" aria-hidden>
