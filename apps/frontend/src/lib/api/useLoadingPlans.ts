  ...
  'a1b2c3d4-0001-0000-0000-000000000001': [
    {
      ...
      color: '#3b82f6',
      products: [
        { id: 'pd-001-001', name: 'Dizüstü Bilgisayar HP ProBook 450 G10', quantity: 12, unitWeightKg: 1.9, layerCount: 2, constraints: ['fragile', 'no_rotate'] },
        { id: 'pd-001-002', name: 'Monitör Dell 27" 4K USB-C', quantity: 6, unitWeightKg: 4.5, layerCount: 1, constraints: ['fragile'] },
        { id: 'pd-001-003', name: 'Klavye + Mouse Seti Logitech MX', quantity: 24, unitWeightKg: 0.4, layerCount: 3, constraints: [] },
      ],
    },
    {
      id: 'GRP-IST-002',
      ...
      color: '#10b981',
      products: [
        { id: 'pd-001-004', name: 'A4 Kağıt Koli (5 Paket × 500 Yaprak)', quantity: 20, unitWeightKg: 12.5, layerCount: 4, constraints: ['bottom_only'] },
        { id: 'pd-001-005', name: 'Arşiv Klasörü Çift Mekanizmalı', quantity: 80, unitWeightKg: 0.3, layerCount: 5, constraints: [] },
        { id: 'pd-001-006', name: 'Plastik Dosya — Şeffaf A4', quantity: 120, unitWeightKg: 0.05, layerCount: 6, constraints: [] },
      ],
    },
  ],
  'a1b2c3d4-0002-0000-0000-000000000002': [
    {
      ...
      color: '#f59e0b',
      products: [
        { id: 'pd-002-001', name: 'Endüstriyel Yağlayıcı — 20 L Varil', quantity: 8, unitWeightKg: 18.0, layerCount: 1, constraints: ['bottom_only', 'hazmat', 'liquid'] },
        { id: 'pd-002-002', name: 'Boya Solüsyonu Renksiz 10 L', quantity: 12, unitWeightKg: 11.2, layerCount: 1, constraints: ['hazmat', 'liquid'] },
      ],
    },
    {
      id: 'GRP-IZM-002',
      ...
      color: '#6b7280',
      products: [
        { id: 'pd-002-003', name: 'Çelik Flanş DN150 PN16', quantity: 24, unitWeightKg: 8.4, layerCount: 2, constraints: ['heavy_side'] },
        { id: 'pd-002-004', name: 'Alüminyum Profil 6060 T5 — 3m', quantity: 30, unitWeightKg: 6.1, layerCount: 1, constraints: ['no_rotate'] },
      ],
    },
  ],
  'a1b2c3d4-0003-0000-0000-000000000003': [
    {
      ...
      color: '#8b5cf6',
      products: [
        { id: 'pd-003-001', name: 'Bulaşık Makinesi Bosch Serie 6 — 60cm', quantity: 6, unitWeightKg: 52.0, layerCount: 1, constraints: ['fragile', 'bottom_only'] },
        { id: 'pd-003-002', name: 'Çamaşır Makinesi Arçelik 9 kg', quantity: 8, unitWeightKg: 70.0, layerCount: 1, constraints: ['fragile', 'bottom_only'] },
        { id: 'pd-003-003', name: 'Kurutma Makinesi Beko 7 kg', quantity: 4, unitWeightKg: 40.0, layerCount: 1, constraints: ['fragile'] },
        { id: 'pd-003-004', name: 'Buzdolabı No-Frost 450L', quantity: 2, unitWeightKg: 85.0, layerCount: 1, constraints: ['fragile', 'bottom_only', 'no_rotate'] },
      ],
    },
    {
      id: 'GRP-BUR-002',
      ...
      color: '#ec4899',
      products: [
        { id: 'pd-003-005', name: 'Mikser Standlı KitchenAid Artisan', quantity: 10, unitWeightKg: 11.0, layerCount: 2, constraints: ['fragile'] },
        { id: 'pd-003-006', name: 'Kahve Makinesi Espresso Philips', quantity: 12, unitWeightKg: 5.5, layerCount: 2, constraints: ['fragile'] },
        { id: 'pd-003-007', name: 'Tost Makinesi Tefal — 3in1', quantity: 18, unitWeightKg: 1.8, layerCount: 3, constraints: [] },
        { id: 'pd-003-008', name: 'Su Isıtıcısı 1.7L İnox', quantity: 20, unitWeightKg: 0.9, layerCount: 4, constraints: [] },
      ],
    },
  ],
  'a1b2c3d4-0004-0000-0000-000000000004': [
    {
      ...
      color: '#1d4ed8',
      products: [
        { id: 'pd-004-001', name: 'Kot Kumaş Rulo Lacivert — 100m', quantity: 15, unitWeightKg: 28.0, layerCount: 1, constraints: ['no_rotate'] },
        { id: 'pd-004-002', name: 'Kot Kumaş Rulo Siyah — 100m', quantity: 12, unitWeightKg: 28.0, layerCount: 1, constraints: ['no_rotate'] },
        { id: 'pd-004-003', name: 'Streç Kumaş Beyaz — 50m', quantity: 20, unitWeightKg: 8.0, layerCount: 2, constraints: [] },
        { id: 'pd-004-004', name: 'Pamuk Krep Bej — 50m', quantity: 8, unitWeightKg: 5.5, layerCount: 2, constraints: [] },
      ],
    },
    {
      id: 'GRP-ADA-002',
      ...
      color: '#059669',
      products: [
        { id: 'pd-004-005', name: 'Erkek Gömlek Koli (24 adet) XL', quantity: 12, unitWeightKg: 3.2, layerCount: 4, constraints: [] },
        { id: 'pd-004-006', name: 'Kadın Bluz Koli (24 adet) M', quantity: 18, unitWeightKg: 2.8, layerCount: 4, constraints: [] },
        { id: 'pd-004-007', name: 'Çocuk T-Shirt Koli (48 adet)', quantity: 10, unitWeightKg: 2.2, layerCount: 5, constraints: [] },
      ],
    },
  ],
  'a1b2c3d4-0005-0000-0000-000000000005': [
    {
      ...
      color: '#fbbf24',
      products: [
        { id: 'pd-005-001', name: 'UHT Süt 1L Tam Yağlı (12li koli)', quantity: 40, unitWeightKg: 12.8, layerCount: 3, constraints: ['liquid'] },
        { id: 'pd-005-002', name: 'Ayran 200ml Cam Şişe (24li koli)', quantity: 30, unitWeightKg: 5.4, layerCount: 3, constraints: ['fragile', 'liquid'] },
        { id: 'pd-005-003', name: 'Peynir Beyaz 500g Kapalı Kova', quantity: 25, unitWeightKg: 0.52, layerCount: 4, constraints: [] },
        { id: 'pd-005-004', name: 'Tereyağı 250g (24li koli)', quantity: 20, unitWeightKg: 6.2, layerCount: 3, constraints: [] },
        { id: 'pd-005-005', name: 'Yoğurt 1kg Tam Yağlı (6lı koli)', quantity: 35, unitWeightKg: 6.1, layerCount: 3, constraints: [] },
      ],
    },
    {
      id: 'GRP-ANK-002',
      ...
      color: '#d97706',
      products: [
        { id: 'pd-005-006', name: 'Pirinç Baldo 5kg Torba (5li koli)', quantity: 50, unitWeightKg: 25.5, layerCount: 2, constraints: ['bottom_only', 'heavy_side'] },
        { id: 'pd-005-007', name: 'Makarna Spagetti 500g (24lü koli)', quantity: 45, unitWeightKg: 12.3, layerCount: 4, constraints: [] },
        { id: 'pd-005-008', name: 'Un 1kg (12li koli)', quantity: 38, unitWeightKg: 12.1, layerCount: 3, constraints: [] },
        { id: 'pd-005-009', name: 'Şeker 1kg Kesme (10lu koli)', quantity: 28, unitWeightKg: 10.2, layerCount: 4, constraints: [] },
        { id: 'pd-005-010', name: 'Zeytinyağı 1L Cam Şişe (6lı koli)', quantity: 22, unitWeightKg: 6.5, layerCount: 2, constraints: ['fragile', 'liquid'] },
        { id: 'pd-005-011', name: 'Tuz Rafine 1kg (12li koli)', quantity: 18, unitWeightKg: 12.0, layerCount: 4, constraints: [] },
        { id: 'pd-005-012', name: 'Nohut 1kg (10lu koli)', quantity: 15, unitWeightKg: 10.3, layerCount: 3, constraints: [] },
      ],
    },
  ],
  'a1b2c3d4-0006-0000-0000-000000000006': [
    {
      ...
      color: '#92400e',
      products: [
        { id: 'pd-006-001', name: 'Seramik Yer Karosu 60×60 (10lu koli)', quantity: 20, unitWeightKg: 22.0, layerCount: 2, constraints: ['fragile', 'bottom_only'] },
        { id: 'pd-006-002', name: 'Duvar Boyası Mat Beyaz 15L', quantity: 12, unitWeightKg: 18.5, layerCount: 2, constraints: ['liquid', 'bottom_only'] },
        { id: 'pd-006-003', name: 'Alçı Torba 25kg', quantity: 16, unitWeightKg: 25.0, layerCount: 1, constraints: ['bottom_only', 'heavy_side'] },
      ],
    },
  ],
};
