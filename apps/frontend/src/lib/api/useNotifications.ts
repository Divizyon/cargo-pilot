...
const MOCK_NOTIFICATIONS: Notification[] = [
  {
    ...
    description: 'SAP bağlantısı kurulamadı. Bağlantı zaman aşımına uğradı (30s). Entegrasyon ayarlarınızı kontrol edin.',
  ...
  },
  {
    ...
    description: 'Bu ay 400/500 plan oluşturuldu. Limitinize yaklaşıyorsunuz. Planınızı yükseltmeyi düşünün.',
    actionUrl: null,
    isRead: false,
    readAt: null,
    createdAt: hours(1),
  },
  {
    ...
    description: 'Q1 2026 dönemsel raporu oluşturulurken hata meydana geldi. Lütfen daha sonra tekrar deneyin.',
    actionUrl: null,
    isRead: false,
    readAt: null,
    createdAt: hours(2),
  ...
  },
  {
    ...
    description: 'PLN-2026-007 planı optimize edilirken hata oluştu. Ürün kısıtları çakışıyor olabilir.',
  ...
  },
  {
    ...
    description: 'Bu ayki 500 plan limitinize ulaştınız. Yeni plan oluşturmak için planınızı yükseltin.',
    actionUrl: null,
    isRead: true,
    readAt: days(5),
    createdAt: days(5),
