...
export const usePlanStore = create<PlanStore>((set) => ({
  ...
  setClusterGroups: (clusterGroups) => set({ clusterGroups }),
  setAllowContamination: (allowContamination) => set({ allowContamination }),
  setInlineGroups: (inlineGroups) => set({ inlineGroups }),
