...
namespace CargoPilot.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260518164154_FixVehicleDimensionsNullableAndConstraints")]
    partial class FixVehicleDimensionsNullableAndConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CargoPilot.Domain.Entities.Item", b =>
                {
                    ...
                    b.Property<bool>("IsRuleAssigned")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("CargoPilot.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CompanyId", "Type", "CreatedAtUtc");
            ...
            modelBuilder.Entity("CargoPilot.Domain.Entities.PendingItemMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("CargoPilotItemId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ErpProductName")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("CargoPilot.Domain.Entities.SyncLog", b =>
                {
                    ...
                    b.Property<int>("RuleNotAssignedCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("CargoPilot.Domain.Entities.PendingItemMapping", b =>
                {
                    b.HasOne("CargoPilot.Domain.Entities.Item", "CargoPilotItem")
                        .WithMany()
                        .HasForeignKey("CargoPilotItemId")
                        .OnDelete(DeleteBehavior.SetNull);
