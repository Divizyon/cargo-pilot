...
| **F5** · Ürünleştirme | Kalıcılık, migration, frontend, gecelik CI kapısı | **KISMİ** — değişmez kapsaması (67 → 111 test), ölçülen arama bütçesi (`DR-25`), koşu kimliği kalıcı + migration (`DR-26`). **Kalan: frontend'de strateji seçimi, gecelik CI kapısı** | KK-06b, KK-07 |
